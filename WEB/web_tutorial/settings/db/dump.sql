...
INSERT INTO `login` VALUES ('guest','guest'),('test','test'),('qwe','qwe'),('admin','62cee9b60efa0350f9b397d2cfb14bf2ce0318f43ba80a34f0235125d37537b1');
...
GRANT SELECT ON `users`.* TO 'kuality'@'%';

-- Dump completed on 2024-08-06 11:50:13
